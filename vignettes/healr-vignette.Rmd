...
filtered_list <- filter_bins(heal_list = count_list,
                             ...
                             count_threshold = 3)
```
Here we removed bins with average per base mappability below 0.9 and replace any count values 3 times the standard deviation above the mean with NA. This is the default behavior of this function. <br>
